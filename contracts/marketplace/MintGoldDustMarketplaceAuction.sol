...
contract MintGoldDustMarketplaceAuction is MintGoldDustMarketplace {
  ...
  function list(
    ...
    list(_listDTO, address(this), auctionIds.current(), msg.sender);
  ...
  function placeBid(BidDTO memory _bidDTO) external payable nonReentrant {
    ...
    isTokenIdListed(_bidDTO.tokenId, _bidDTO.contractAddress, _bidDTO.seller);
    ...
    if (
      ...
      delete checkBidder[msg.sender][_bidDTO.contractAddress][_bidDTO.tokenId][
        _bidDTO.seller
      ];
    }
  }
  ...
  function cancelAuction(
    ...
    require(
      idMarketItemsByContractByOwner[_contractAddress][_tokenId][msg.sender]
        .seller == msg.sender,
      "Unauthorized"
    );
