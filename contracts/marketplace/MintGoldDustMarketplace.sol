  ...
  ReentrancyGuardUpgradeable
{
  ...
  function primarySale(
    ...
    unchecked {
      ...
      (bool success, ) = payable(mintGoldDustCompany.owner()).call{
        value: collFee + fee
      }("");
  ...
  function splittedSale(
    ...
    emit NftPurchasedCollaboratorAmount(itemsSold, _artist, balanceSplitPart);
