...
async function main() {
  ...
  await mintGoldDustSetPrice
    .connect(deployer)
    .setPublicKey("0x2C703529Fed699921487c6D362893CaB3CA21752");
  ...
  await mintGoldDustCompany
    .connect(deployer)
    .setValidator("0xA0bb30cc1838D7cc3e3EC33f185349Cb891e97FE", true);

  // Chris address
  await mintGoldDustCompany
    .connect(deployer)
    .setValidator("0x49a44EC6243b516cB699F1aD7b8731e54cFEc978", true);
  /************************************** MintGoldDustMarketplaceAuction FINAL *************************************/
